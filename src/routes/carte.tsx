...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    img: catGlacees,
    dishes: [
      { name: "Iced Matcha Latte", price: "5,00 €", glutenFree: true, vegetarian: true, lactoseFree: false },
      { name: "Iced Américano", price: "4,00 €", glutenFree: true, vegetarian: true, lactoseFree: true },
      { name: "Iced Flat White", price: "5,50 €", glutenFree: true, vegetarian: true, lactoseFree: false },
      { name: "Iced Chaï Latte Café", price: "5,50 €", glutenFree: true, vegetarian: true, lactoseFree: false },
      ...
      { name: "Iced Matcha Latte au Collagène & Sésame Noir", price: "6,50 €", glutenFree: true, vegetarian: true, lactoseFree: false },
      { name: "Iced Latte", price: "5,00 €", glutenFree: true, vegetarian: true, lactoseFree: false },
      { name: "Iced Matcha Latte au Sésame Noir", price: "6,00 €", glutenFree: true, vegetarian: true, lactoseFree: false },
